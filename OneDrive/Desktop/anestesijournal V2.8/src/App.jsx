...
export default function App() {
  ...
  useEffect(() => { loadCustom().then(setCustomDoses); }, []);
  useEffect(() => {
    ...
    <div className="aj">
      ...
      <main className={"wrap" + (printAll ? " printing-all" : "")}>
        <div className="tabcontent">
          {tab === "premed" && <PremedSheet c={c} set={set} setC={setC} customDoses={customDoses} addCustomDose={addCustomDose} clearCustomDoses={clearCustomDoses} />}
        ...
        {printAll && (
          <div className="printall">
            <PremedSheet c={c} set={set} setC={setC} customDoses={customDoses} addCustomDose={addCustomDose} clearCustomDoses={clearCustomDoses} />
...
function PremedSheet({ c, set, setC, customDoses, addCustomDose, clearCustomDoses }) {
